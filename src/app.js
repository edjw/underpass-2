...
//
let midiAccess = null;
let midiFromDevice = null;
let midiToDevice = null;
...
let midiSampleDumpPackets = [];
let midiSampleDumpHeader = null;
...
function abortMidiTransfer(reason) {
    clearMidiTimeout();
    if (recCurStatusNode)
        recCurStatusNode.textContent = reason;
    recButton.disabled = false;
    stopButton.disabled = true;
    midiSampleDumpPacketsSent = midiSampleDumpPacketsTotal; // Stop sending
}
function midiSendSampleName(deviceID, sampleNumber, name) {
...
stopButton.disabled = true;
const sampleIDInput = document.querySelector("input#sampleID");
const sampleNameInput = document.querySelector("input#sampleName");
const recTable = document.querySelector("table#recordings");
const recTrPrototype = document.querySelector("#recordingPrototype");
let recCurNode = null;
let recCurFileNameNode = null;
let recCurDurationNode = null;
let recCurStatusNode = null;
let recCurProgressInnerNode = null;
...
function recorderStart() {
    ...
    recCurNode = recTrPrototype.content.firstElementChild.cloneNode(true);
    ...
    recCurProgressInnerNode = recCurNode.querySelector(".progressInner");
...
// Legal notice
//
const legalButton = document.querySelector("button#legalButton");
const legalNotice = document.querySelector("div#legalNotice");
const legalCloseButton = document.querySelector("button#legalClose");
